...
public class mydatabase extends SQLiteOpenHelper {
    ...
    private void chat(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE chat (id INTEGER PRIMARY KEY AUTOINCREMENT, msgId TEXT UNIQUE, userName TEXT, userId TEXT, msg TEXT,
                userGender TEXT, groupNumber TEXT)");
    }
