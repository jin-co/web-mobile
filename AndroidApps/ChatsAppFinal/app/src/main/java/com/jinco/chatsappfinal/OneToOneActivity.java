...
public class OneToOneActivity extends AppCompatActivity {
    ...
    private ArrayList<Message> onlineMessages = new ArrayList<>();
    private ArrayList<Message> offlineMessages = new ArrayList<>();
            ...
            myRef.child("oneToOne").child(chatRoomId).orderByKey().startAt(lastmsg).addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    for (DataSnapshot singleSnapShot : snapshot.getChildren())
                        onlineMessages.add(singleSnapShot.getValue(Message.class));
    ...
    private void _msgSend() {
        try {
            ...
            Message msgClass = new Message(key, userName, userId, msg, userGender);
